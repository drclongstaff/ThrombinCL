  ...
  sidebarLayout(                                      
    ...
    sidebarPanel( 
      ...
      fluidRow(
        ...
        column(5, numericInput("limitD", label = h5("limit points for fitting"), value = 60, step = 5))
      ...
      fluidRow(
        ...
        column(4, numericInput("calSlope", label = h5("Calibrator initial rate"), value = 80, step = 25))#,
      ...
      fluidRow(
          column(4,  fileInput("data1", label = "Select sample data")), 
          
          column(4, numericInput("numrows",
                                 label = h5("plot nrows?"), value = 7)),
          
          column(4,   numericInput("truncpoints",label = h5("truncate data"), value = 150))
     ...
     fluidRow(
        ...
        column(4, numericInput("smtail", label =h5("Smooth tail"), value = 100)),
